...
// function returns `null` on failure instead of throwing, and the caller
// below (~line 133) depends on that to do an opportunistic retry. It also
// null-guards `expires_in`, unlike the helper's throwing contract. Any future
// migration (Phase 4, HLT-2) must wrap `refreshGoogleToken` in try/catch ->
// null rather than blind-swapping it in here.
